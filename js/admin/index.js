...
layui.config({
	...
	// 获取导航数据并设置navbar
	$.getJSON("/admin/ajax/getNav", function(data){
		if(data.success){
			...
			layer.msg('ajax获取nav错误');
		}
	})
	
	//设置navbar (通过设置url获取数据错误，jq报错：“Synchronous XMLHttpRequest on the main thread is deprecated”)
	// navbar.set({
	// 	spreadOne: true,
	// 	elem: '#admin-navbar-side',
	// 	cached: true,
